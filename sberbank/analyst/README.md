...
```VBA
Sub exercise_3()
    Dim a, i as Integer, average1 as Double, average2 as Double  ' Так как будем сохранять дробные числа, выберем подходящий для них тип данных
    a = Array(Array(1, 2, 3, 4, 5), _          
              Array(6, 7, 8, 9, 10), _
              Array(11, 12, 13, 14, 15), _
              Array(16, 17, 18, 19, 20), _
    ...
    For i = 0 To 4                                      
        average1 = average1 + a(i)(i)                            ' За один проход цикла выполняем сразу два действия:
        average2 = average2 + a(i)(4-i)                          ' накапливаем суммы обеих диагоналей для вычисления ср. арифм.
    Next i
    average1 = average1 / 5
    average2 = average2 / 5
